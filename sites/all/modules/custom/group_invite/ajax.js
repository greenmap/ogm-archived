 ...
 * @param url 
 *  String url typicaly callback menu path processes informaiton example /dev/oqm_miikka/example
 * @param params 
 *  String POST params to url example: arg1=12&arg2=abc
 * @param returnFunc 
 *  String name of return handle function example: real name: Drupal.example => string: example
 * @param returnArgs 
 *  mixed Anything you might need to put to return handler function
 */
