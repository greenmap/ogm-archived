  ...
  GEvent.addListener(object, "click", function() {
	...
	html.onreadystatechange = function() {
		...
		if (html.status == 200) {// success
			...
			fullpageDiv.id = "iphoneFullDiv";
			fullpageDiv.innerHTML = html.responseText;
			if(!document.getElementById('iphoneFullDiv')){
...
closeiPhoneFullDiv = function() {
	var div = document.getElementById('iphoneFullDiv');
